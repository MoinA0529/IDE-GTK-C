...
// Files → Quit menu item. Mnemonics are shortcuts for GUI elements such as text entries or buttons; they appear
// as underlined characters. Of course, menu items can have both accelerators and mnemonics.
